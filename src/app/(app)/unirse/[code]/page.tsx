...
import { ErrorBanner, LinkButton } from "@/components/ui/legacy";
import { joinGroup } from "@/app/(app)/grupos/actions";
...
export default async function JoinPage({ params }: { params: Promise<{ code: string }> }) {
  ...
  return (
    <Shell title="Invitación" back="/">
      ...
      <p className="mt-4 text-sm text-muted-foreground">El link puede haber sido revocado. Pedile uno nuevo al admin del grupo.</p>
