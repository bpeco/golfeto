...
- [x] "Los Cedros" era **CUBA Villa de Mayo**, par 68 (2026-09-25): renombrada y cargada de la foto de la tarjeta del club (9 hoyos × 2, tees Azules/Blancas/Rojas). Layout provisional dado de baja y todas sus partidas movidas a la versión real (golpes incluidos). Historial de Manu corregido: +38/+25 eran sobre par 68 → 106 y 93. Históricas de Manu y Agus refirmadas; la tarjeta del dueño de ese día quedó desfirmada para que la firme desde la app. Detalle en `docs/handoff.md`
- [ ] CR/Slope oficial de CUBA Villa de Mayo (hoy 68 / 113 aproximado; azules y rojas sin rating). La búsqueda web no llegó: la AAG lo midió en 2017 y está en la nota del club "Recalificación de las canchas de golf del club" (cuba.org.ar), en la app de la AAG o en la oficina de golf. Candidato sin verificar: 34.7 / 113 de 9 hoyos (GolfPass, solo en snippets)
