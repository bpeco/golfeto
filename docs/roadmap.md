...
- [x] Tira de hoyos del modo hoyo con la notación de la tarjeta (2026-09-25, pedido del dueño): cada hoyo con su marca (`ScoreMark xs`: círculo birdie, doble círculo eagle, cuadrado bogey, doble cuadrado doble bogey o peor, barra no terminado, par sin marca); el hoyo actual con recuadro en vez de celda invertida
